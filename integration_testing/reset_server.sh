...
mysql -D aichallenge < ~/aichallenge/sql/0_schema.sql
mysql -D aichallenge < ~/aichallenge/sql/1_data.sql
mysql -D aichallenge < ~/aichallenge/sql/2_generate_matchup.sql
#mysql -D aichallenge < ~/aichallenge/sql/3_worker.sql
